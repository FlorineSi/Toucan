...
public class VueAnimation extends JPanel {
	...
	private static int temporisation = 0;
	...
	public void paintComponent(Graphics g) {
		...
		for (int i = 0; i < lesCasesGraphiques.size(); i++) {
			lesCasesGraphiques.dessiner(g2,i); // Ajouter temps
			try {
	...
	public static void setTemporisation(int temporisation) {
		VueAnimation.temporisation = temporisation;
	}
}
